 ...
 * @license     https://github.com/ticketevolution/ticketevolution-php/blob/master/LICENSE.txt     New BSD License
 */
class EventPerformers extends AbstractTable
{
    /**
     * The table name.
     *
     * @var string
     */
    protected $_name   = 'tevoEventPerformers';
     ...
     * @var mixed
     */
    protected $_primary   = array('eventId', 'performerId');
     ...
     * @var string
     */
    protected $_statusColumn   = 'eventPerformersStatus';
